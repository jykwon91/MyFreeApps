"""MyPizzaTracker FastAPI application.
...
from app.api import account, admin, drops, health, menu, public, service, totp
    ...
    if not email or not hashed_password:
        if settings.environment == "production":
            raise SeedUserNotConfiguredError(
                ...
                "production. See apps/mypizzatracker/backend/.env.docker.example."
            )
        logger.warning(
