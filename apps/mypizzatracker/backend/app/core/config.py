"""MyPizzaTracker application settings.
...
class Settings(BaseAppSettings):
    ...
    cors_origins: list[str] = ["http://localhost:5178"]
    minio_bucket: str = "mypizzatracker-uploads"
    email_from_name: str = "MyPizzaTracker"
    ...
    # ------------------------------------------------------------------
    totp_label: str = "MyPizzaTracker"
    totp_issuer: str = "MyPizzaTracker"
