...
COPY apps/mygamingassistant/backend/requirements.txt ./
...
COPY apps/mygamingassistant/backend/ /app/
COPY apps/mygamingassistant/docker/entrypoint.sh /entrypoint.sh
