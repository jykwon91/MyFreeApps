 ...
 *
 * Supports TOTP challenge (same flow as MJH), email verification resend, and
 * a "Create account" link to the self-serve /register route.
 * Mirrors apps/myjobhunter/frontend/src/pages/Login.tsx.
 */
