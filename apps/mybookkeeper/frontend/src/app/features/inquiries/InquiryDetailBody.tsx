...
import InquiryStageDropdown from "./InquiryStageDropdown";
import InquiryDetailSkeleton from "./InquiryDetailSkeleton";
import InquiryQualityBreakdown from "./InquiryQualityBreakdown";
import InquiryEventTimeline from "./InquiryEventTimeline";
import InquiryMessageThread from "./InquiryMessageThread";
import InquiryNotesEditor from "./InquiryNotesEditor";
import InquirySpamTriagePanel from "./InquirySpamTriagePanel";
...
export interface InquiryDetailBodyProps {
  mode: InquiryDetailMode | null;
  inquiry: InquiryResponse | undefined;
}

export default function InquiryDetailBody({
  mode,
  inquiry,
}: InquiryDetailBodyProps) {
