...
Suggested grouping: ~~PR1 = empty-state hint + verify/fix picker query + refuse-to-guess-on-duplicate-names~~ **DONE 2026-05-30**; PR2 = payer_alias learning (the remaining [HIGH] "Remember for next time"); PR3 (optional) = stable sender-handle capture for same-name payers (the [DESIGN] item).
