...
Last verified auto-deploy from MyFreeApps main: 2026-04-26 (post-#84 ssh-action SHA fix + SSH_HOST/SSH_USER/SSH_PRIVATE_KEY secrets configured + private key re-uploaded directly from /root/.ssh/deploy_key file).
